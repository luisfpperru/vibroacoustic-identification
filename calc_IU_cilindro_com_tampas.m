function calc_IU_cilindro_com_tampas(freq_adim)
    ...
    load('cilindro.mat','desl','coord','conec')
...
%     toc % para o cronï¿½metro e exibe o tempo de operaï¿½ï¿½o
    ...
    figure
    subplot(2,2,1)
%     plotagrandeza3(coord,conec,IS3) % plota a intensidade acustica supersonica analitica
%     title('IS via Magalhaes')
    plotagrandeza3(coord,conec,I) % plota a intensidade acustica supersonica analitica
    title('I')
    subplot(2,2,2)
    ...
    title('INN Sim')
    saveas(gcf,['resultados/cilindro com tampas grandezas - ',num2str(frequencia),'.png'])


    figure
    plotagrandeza3(coord,conec,imag(v))% plota a intensidade acústica
    saveas(gcf,['resultados/cilindro com tampas Velos - ',num2str(frequencia),'.png'])
    
    figure
    plotagrandeza3(coord,conec,I) % plota a intensidade acustica numerica
    saveas(gcf,['resultados/cilindro com tampas IA - ',num2str(frequencia),'.png'])
    
  
    figure
    plotagrandeza3(coord,conec,IU) % plota a intensidade acustica util
    saveas(gcf,['resultados/cilindro com tampas IU - ',num2str(frequencia),'.png'])
    
    figure
    plotagrandeza3(coord,conec,INN_Assim) % plota a intensidade nao negativa assimetrica
    saveas(gcf,['resultados/cilindro com tampas INN Assim - ',num2str(frequencia),'.png'])
   
     figure
    plotagrandeza3(coord,conec,INN_Sim) % plota a intensidade nao negativa simetrica
    saveas(gcf,['resultados/cilindro com tampas INN Sim - ',num2str(frequencia),'.png'])
    
%     figure
%     plotagrandeza3(coord,conec,IS3) % plota a intensidade acustica supersonica numerica
%     saveas(gcf,['resultados/cilindro com tampas IS via Magalhaes - ',num2str(frequencia),'.png'])
...
%     % Plota a contribuiï¿½ï¿½o dos valores prï¿½prios   
    ...
    saveas(gcf,['resultados/cilindro com tampas convergencia potencia - ',num2str(frequencia),'.png'])
    aux = [rc;somas_pot];
    save(['resultados/cilindro com tampas convergencia potencia - ',num2str(frequencia),'.txt'],'aux','-ascii','-double')
