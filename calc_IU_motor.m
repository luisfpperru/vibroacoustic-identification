function calc_IU_motor(frequencia)
    ...
    load('motor.mat','desl','coord','conec')
...
%     title('IS via Magalhaes')
    ...
    title('INN Sim')
    saveas(gcf,['resultados/motor grandezas - ',num2str(frequencia),'.png'])
    saveas(gcf,['resultados/motor grandezas - ',num2str(frequencia),'.fig'])


    figure
    plotagrandeza3(coord,conec,imag(v))% plota a intensidade acústica
    saveas(gcf,['resultados/motor Velos - ',num2str(frequencia),'.png'])
    saveas(gcf,['resultados/motor Velos - ',num2str(frequencia),'.fig'])

    
    figure
    plotagrandeza3(coord,conec,I) % plota a intensidade acustica numerica
    saveas(gcf,['resultados/motor IA - ',num2str(frequencia),'.png'])
    saveas(gcf,['resultados/motor IA - ',num2str(frequencia),'.fig'])
  
    figure
    plotagrandeza3(coord,conec,IU) % plota a intensidade acustica util
    saveas(gcf,['resultados/motor IU - ',num2str(frequencia),'.png'])
    saveas(gcf,['resultados/motor IU - ',num2str(frequencia),'.fig'])

    
    figure
    plotagrandeza3(coord,conec,INN_Assim) % plota a intensidade nao negativa assimetrica
    saveas(gcf,['resultados/motor INN Assim - ',num2str(frequencia),'.png'])
    saveas(gcf,['resultados/motor INN Assim - ',num2str(frequencia),'.fig'])

   
     figure
    plotagrandeza3(coord,conec,INN_Sim) % plota a intensidade nao negativa simetrica
    saveas(gcf,['resultados/motor INN Sim - ',num2str(frequencia),'.png'])
    saveas(gcf,['resultados/motor INN Sim - ',num2str(frequencia),'.fig'])
    
%     figure
%     plotagrandeza3(coord,conec,IS3) % plota a intensidade acustica supersonica numerica
%     saveas(gcf,['resultados/motor IS via Magalhaes - ',num2str(frequencia),'.png'])
%     saveas(gcf,['resultados/motor IS via Magalhaes - ',num2str(frequencia),'.fig'])
...
%     % Plota a contribuiï¿½ï¿½o dos valores prï¿½prios   
    ...
    saveas(gcf,['resultados/motor convergencia potencia - ',num2str(frequencia),'.png'])
    aux = [rc;somas_pot];
    save(['resultados/motor convergencia potencia - ',num2str(frequencia),'.txt'],'aux','-ascii','-double')
